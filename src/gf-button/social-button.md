...
## Flutter Circular/Rounded  Social Button
...
We will be able to get **circular or rounded** **shaped** **button** with solid background color with rounded corners by adding property **shape** with `GFButtonShape.pills` .
